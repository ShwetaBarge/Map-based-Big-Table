...
public class MapSort extends MapIterator implements GlobalConst {
    ...
    public MapSort(AttrType[] attrTypes,
        ...
        try {
            tempMap.setMapHeader(BigTable.BIGT_ATTR_TYPES, BigTable.BIGT_STR_SIZES);
        } catch (Exception e) {
...
//        for (int k = 0; k < _num_pages; k++) bufs[k] = new byte[MAX_SPACE];
        ...
        try {
            ...
            op_map_buf.setMapHeader(BigTable.BIGT_ATTR_TYPES, BigTable.BIGT_STR_SIZES);
        } catch (Exception e) {
    ...
    private int generate_runs(int max_elems, AttrType sortFldType, int sortFldLen) throws Exception {
        ...
        try {
            lastElem.setMapHeader(BigTable.BIGT_ATTR_TYPES, BigTable.BIGT_STR_SIZES);
    ...
    */
        ...
        if (!i_buf[cur_node.run_num].empty()) {
            ...
            try {
                ...
                newMap.setMapHeader(BigTable.BIGT_ATTR_TYPES, BigTable.BIGT_STR_SIZES);
